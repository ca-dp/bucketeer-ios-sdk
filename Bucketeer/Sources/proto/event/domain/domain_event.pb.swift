...
struct Bucketeer_Event_Domain_Event {
  ...
  var isAdminEvent: Bool {
    get {return _storage._isAdminEvent}
    set {_uniqueStorage()._isAdminEvent = newValue}
  }
...
struct Bucketeer_Event_Domain_OpsEventRateClauseAddedEvent {
  ...
  var clauseID: String {
    get {return _storage._clauseID}
    set {_uniqueStorage()._clauseID = newValue}
  }
...
extension Bucketeer_Event_Domain_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _isAdminEvent = source._isAdminEvent
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 8: try decoder.decodeSingularStringField(value: &_storage._environmentNamespace)
        case 9: try decoder.decodeSingularBoolField(value: &_storage._isAdminEvent)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._environmentNamespace.isEmpty {
        try visitor.visitSingularStringField(value: _storage._environmentNamespace, fieldNumber: 8)
      }
      if _storage._isAdminEvent != false {
        try visitor.visitSingularBoolField(value: _storage._isAdminEvent, fieldNumber: 9)
      }
  ...
  static func ==(lhs: Bucketeer_Event_Domain_Event, rhs: Bucketeer_Event_Domain_Event) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._isAdminEvent != rhs_storage._isAdminEvent {return false}
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularStringField(value: &_storage._id)
        case 2: try decoder.decodeSingularMessageField(value: &_storage._variation)
        default: break
        }
      }
    }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1: try decoder.decodeSingularStringField(value: &_storage._featureID)
        case 2: try decoder.decodeSingularStringField(value: &_storage._ruleID)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._clause)
        default: break
        }
      }
    }
...
extension Bucketeer_Event_Domain_SegmentRuleClauseAddedEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularStringField(value: &_storage._segmentID)
        case 2: try decoder.decodeSingularStringField(value: &_storage._ruleID)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._clause)
        default: break
        }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._segmentID.isEmpty {
        try visitor.visitSingularStringField(value: _storage._segmentID, fieldNumber: 1)
      }
      if !_storage._ruleID.isEmpty {
        try visitor.visitSingularStringField(value: _storage._ruleID, fieldNumber: 2)
      }
...
extension Bucketeer_Event_Domain_OpsEventRateClauseAddedEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularStringField(value: &_storage._clauseID)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._clauseID.isEmpty {
        try visitor.visitSingularStringField(value: _storage._clauseID, fieldNumber: 1)
      }
  ...
  static func ==(lhs: Bucketeer_Event_Domain_OpsEventRateClauseAddedEvent, rhs: Bucketeer_Event_Domain_OpsEventRateClauseAddedEvent) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._clauseID != rhs_storage._clauseID {return false}
