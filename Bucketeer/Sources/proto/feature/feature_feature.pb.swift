...
extension Bucketeer_Feature_Feature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _variationType: Bucketeer_Feature_Feature.VariationType = .boolean
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._variationType != .boolean {
...
extension Bucketeer_Feature_Tag: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Bucketeer_Feature_Tag, rhs: Bucketeer_Feature_Tag) -> Bool {
